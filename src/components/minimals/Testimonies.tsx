...
export default function Testimonies() {
  return (
    <section className=" bg-bleu py-16 space-y-8 flex flex-col justify-center">
      ...
      <div className="hidden m-6 lg:flex mx-auto 2xl:max-w-screen-xl xl:max-w-screen-lg lg:max-w-screen-lg">
        <Swiper
          autoplay={{
            delay: 2500,
          ...
          className=" flex gap-2 space-x-3 space-y-3"
        >
      ...
      <div className="hidden m-6 sm:flex lg:hidden">
        <Swiper
          autoplay={{
            delay: 2500,
            disableOnInteraction: false,
