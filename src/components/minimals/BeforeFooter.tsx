...
export default function BeforeFooter() {
  return (
    <section className='relative after:absolute after:bottom-0 after:h-2/4 after:w-full after:bg-bleu'>
        <div className="mx-auto 2xl:max-w-screen-xl xl:max-w-screen-xl lg:max-w-screen-md bg-orange relative after:absolute after:z-10  after:shadow-inner z-10 rounded-xl shadow-lg flex items-center justify-between p-5">
